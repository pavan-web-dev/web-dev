const PostItem = ({
    ...
    return(
        ...
        <div class="col-2 d-flex justify-content-end">
            <img src={post.avatar_location} alt="dummy_image" class="img-fluid rounded-circle basic-avatar" />
        </div>
        <div class="col-10">
            <div>
            ...
            <div class="image-container mt-2">
                    <img src={post.image} alt="imageex" class={`img-fluid basic-fullimage${(!post.post_title && !post.post_content) ? '1': ''}`} />
            </div>
